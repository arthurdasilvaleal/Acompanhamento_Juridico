...
export default function Clientes({ showWindow, setShowWindow, setaddedCliente, showEditwindow, setShowEditwindow, editInfo }){
    ...
    const handleSubmit = async (e) => {
        ...
        if(showWindow){
            try{
                const response = await axios.post("http://10.107.200.6:5000/post_cliente", post_cliente)
            ...
            try{
                const response = await axios.put("http://10.107.200.6:5000/put_cliente", put_cliente)
