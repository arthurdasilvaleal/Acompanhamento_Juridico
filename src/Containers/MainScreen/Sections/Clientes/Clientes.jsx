    ...
    return(
        <>
            ...
            <div className="input-group">
                ...
                <input onChange={(e) => set_cdNumeroEndereco(e.target.value)} autoComplete="off" name="cd_NumeroEndereco" id="cd_NumeroEndereco" className="input" type="text" value={nm_Estado} required/>
            </div>
            <div className="input-group">
                <label className="label" htmlFor="nm_Complemento">Complemento</label>
                <input onChange={(e) => set_nmComplemento(e.target.value)} autoComplete="off" name="nm_Complemento" id="nm_Complemento" className="input" type="text" value={nm_Estado} required/>
            </div>
            <div className="input-group">
            ...
            <Client_button type="submit" onClick={alert("Enviado")}>Adicionar</Client_button>
            </Client_form>
            <hr />
        </>
    )
